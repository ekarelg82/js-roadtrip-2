...
function feedPerOceanologist(numOfGoldfish, numOfOceanologists) {
  ...
  const gramsPerOceanologist = totalFoodNeed / numOfOceanologists

  console.log(`Each Oceanologist should load ${feedPerOceanologist} grams of feed today.`);
}

console.log( feedPerOceanologist(800, 2)); // 800
console.log( feedPerOceanologist(1000, 10)); // 200
console.log( feedPerOceanologist(200, 4)); // 100
